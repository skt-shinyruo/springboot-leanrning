...
- 断点地图：`spring-core-modules/spring-core-tx/docs/part-00-guide/04-breakpoint-map.md`
- 关键分支矩阵：`spring-core-modules/spring-core-tx/docs/part-00-guide/05-branch-decision-matrix.md`
- 排障 playbook：`spring-core-modules/spring-core-tx/docs/appendix/01-common-pitfalls.md`
- 自检清单：`spring-core-modules/spring-core-tx/docs/appendix/02-self-check.md`
