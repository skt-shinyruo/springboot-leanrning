    # Appendix：Explore/Debug 用例索引
    <!-- CHAPTER-CARD:START -->
    !!! summary "章节入口"
        - 这页只做支持：索引 explore/debug 测试和它们观察的对象。
        - 需要机制解释时，跳回主文档。
...
| [dependency-descriptor-and-injection-point.md](dependency-descriptor-and-injection-point.md) | 主文档或支持入口 |
