...
上一章：[02. 00 - Deep Dive Guide（springboot-actuator）](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. 关键分支矩阵（Branch Decision Matrix）](guide-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 168 章：04：关键分支矩阵（Branch Decision Matrix）](guide-branch-decision-matrix.md)
