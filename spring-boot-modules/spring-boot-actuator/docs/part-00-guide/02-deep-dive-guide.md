...
上一章：[01. 主线时间线：Spring Boot Actuator](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 01 - Actuator 基础与暴露](../part-01-actuator/01-actuator-basics.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**02. 00 - Deep Dive Guide（springboot-actuator）**
