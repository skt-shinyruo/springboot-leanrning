...
上一章：[01. 主线时间线：Spring Boot Security](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 401 vs 403：Basic Auth 与授权规则](../part-01-security/01-basic-auth-and-authorization.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
6. [90-common-pitfalls](../appendix/01-common-pitfalls.md)
7. [99-self-check](../appendix/02-self-check.md)
