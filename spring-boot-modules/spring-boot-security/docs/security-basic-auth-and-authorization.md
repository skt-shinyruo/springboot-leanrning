...
上一章：[02. 00 - Deep Dive Guide（springboot-security）](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. CSRF：为什么 GET 没事但 POST 会 403？](security-csrf.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-00-guide/00-deep-dive-guide.md](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-security/02-csrf.md](security-csrf.md)
