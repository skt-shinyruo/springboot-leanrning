...
上一章：[第 87 章：01：401 vs 403：Basic Auth 与授权规则](087-01-basic-auth-and-authorization.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 89 章：03：Method Security 与代理：self-invocation 陷阱](089-03-method-security-and-proxy.md)
<!-- GLOBAL-BOOK-NAV:END -->
