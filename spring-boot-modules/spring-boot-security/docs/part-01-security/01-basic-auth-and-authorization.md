...
上一章：[02. 00 - Deep Dive Guide（springboot-security）](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. CSRF：为什么 GET 没事但 POST 会 403？](02-csrf.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
以为“我已经给了 ADMIN 权限”，但访问 `/api/admin/**` 仍然 403
...
上一章：[part-00-guide/00-deep-dive-guide.md](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-security/02-csrf.md](02-csrf.md)
