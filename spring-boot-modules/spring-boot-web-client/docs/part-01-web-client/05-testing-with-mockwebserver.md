...
上一章：[04. 超时与重试（确定性实验）](04-timeout-and-retry.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 常见坑清单（Web Client）](../appendix/01-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-01-web-client/04-timeout-and-retry.md](04-timeout-and-retry.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/90-common-pitfalls.md](../appendix/01-common-pitfalls.md)
