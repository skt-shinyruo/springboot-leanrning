...
上一章：[05. 测试策略：为什么用 MockWebServer？](web-client-testing-with-mockwebserver.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 99 - Self Check（springboot-web-client）](appendix-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
需要下探源码时，再对照本模块的断点地图与关键分支矩阵去命中入口（filter 链与 exchange 是高频落点）：[04-breakpoint-map.md](guide-breakpoint-map.md) / [05-branch-decision-matrix.md](guide-branch-decision-matrix.md)。
...
上一章：[part-01-web-client/05-testing-with-mockwebserver.md](web-client-testing-with-mockwebserver.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/99-self-check.md](appendix-self-check.md)
