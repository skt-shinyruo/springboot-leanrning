...
上一章：[01. 主线时间线：Spring Boot Web Client](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. RestClient（同步）最小闭环](../part-01-web-client/01-restclient-basics.md)
<!-- GLOBAL-BOOK-NAV:END -->
