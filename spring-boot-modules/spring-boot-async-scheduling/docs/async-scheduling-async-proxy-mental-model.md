...
上一章：[02. 00 - Deep Dive Guide（springboot-async-scheduling）](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. Executor 与线程命名/并发边界](async-scheduling-executor-and-threading.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
然后会遇到第一个挫败：同样的注解，有时能切线程，有时像没写。看起来像玄学，但机制边界其实很硬：
...
当怀疑“它到底有没有异步”时，先不必急于看日志级别、也别先怪线程池配置。
...
上一章：[part-00-guide/00-deep-dive-guide.md](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-async-scheduling/02-executor-and-threading.md](async-scheduling-executor-and-threading.md)
