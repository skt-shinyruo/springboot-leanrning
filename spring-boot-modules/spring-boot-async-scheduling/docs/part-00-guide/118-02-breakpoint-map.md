...
!!! summary "章节学习卡片（断点地图）"
    ...
    这页更像备忘录：你可以不按顺序读，但真排障时往往能省不少时间。
<!-- CHAPTER-CARD:END -->

<!-- GLOBAL-BOOK-NAV:START -->
上一章：[第 118 章：00 - Deep Dive Guide（springboot-async-scheduling）](118-00-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 118 章：04：关键分支矩阵（Branch Decision Matrix）](118-04-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
