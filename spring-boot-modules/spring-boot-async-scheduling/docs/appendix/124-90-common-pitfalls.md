...
!!! summary "章节学习卡片（排障短文）"
    ...
    如果你已经跑过一次 `BootAsyncSchedulingBranchMatrixLabTest`，这章读起来会更像“对照答案”：你会发现很多坑其实都在重复问同一件事——有没有走代理、用了哪个执行器、异常落在哪、上下文有没有清理。
<!-- CHAPTER-CARD:END -->

<!-- GLOBAL-BOOK-NAV:START -->
上一章：[第 128 章：08：Spring Boot `spring.task.*`：默认线程池/调度器与属性映射](../part-01-async-scheduling/128-08-boot-spring-task-autoconfig.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 125 章：99 - Self Check（springboot-async-scheduling）](125-99-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 断点地图：[`118-02-breakpoint-map.md`](../part-00-guide/118-02-breakpoint-map.md)
- 分支矩阵：[`118-04-branch-decision-matrix.md`](../part-00-guide/118-04-branch-decision-matrix.md)
...
上一章：[part-01-async-scheduling/08-boot-spring-task-autoconfig.md](../part-01-async-scheduling/128-08-boot-spring-task-autoconfig.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/99-self-check.md](125-99-self-check.md)
