# 第 126 章：06：`@Async` × `@Transactional`：事务边界与执行线程
<!-- CHAPTER-CARD:START -->
...
上一章：[第 123 章：05：`@Scheduled` 基础与可测试性](123-05-scheduling-basics.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 127 章：07：SecurityContext / RequestContext：默认丢失、传播与泄漏](127-07-security-and-request-context.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-01-async-scheduling/05-scheduling-basics.md](123-05-scheduling-basics.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-async-scheduling/07-security-and-request-context.md](127-07-security-and-request-context.md)
