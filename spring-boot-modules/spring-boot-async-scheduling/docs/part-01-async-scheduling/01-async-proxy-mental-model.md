...
上一章：[02. 00 - Deep Dive Guide（springboot-async-scheduling）](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. Executor 与线程命名/并发边界](02-executor-and-threading.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**01. `@Async` 心智模型：代理与线程切换**
- 建议入口：优先运行 `BootAsyncSchedulingLabTest#asyncAnnotationDoesNothingWithoutEnableAsync`（见文末“对应 Lab/Test”），先跑一次“反例”，再跑一次“正例”，你会更快建立边界感。
...
当你怀疑“它到底有没有异步”时，先不必急于看日志级别、也别先怪线程池配置。
...
上一章：[part-00-guide/00-deep-dive-guide.md](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-async-scheduling/02-executor-and-threading.md](02-executor-and-threading.md)
