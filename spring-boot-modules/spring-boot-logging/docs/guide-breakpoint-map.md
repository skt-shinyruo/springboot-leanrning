...
上一章：[03. Logging 调用链（LoggingSystem 初始化与级别决策）](guide-logging-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. 关键分支矩阵（Logging）](guide-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 200 章：04：关键分支矩阵](guide-branch-decision-matrix.md)
...
上一章：[part-00-guide/01-logging-call-chain.md](guide-logging-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-00-guide/04-branch-decision-matrix.md](guide-branch-decision-matrix.md)
