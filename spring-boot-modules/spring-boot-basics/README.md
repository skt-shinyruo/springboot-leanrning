...
（docs 目录页：[`docs/README.md`](../../docs/basics/spring-boot-basics/README.md)）

1. [配置来源与 Profile 覆盖](../../docs/basics/spring-boot-basics/part-01-boot-basics/01-property-sources-and-profiles.md)
2. [`@ConfigurationProperties` 绑定与类型转换](../../docs/basics/spring-boot-basics/part-01-boot-basics/02-configuration-properties-binding.md)
3. [常见坑清单](../../docs/basics/spring-boot-basics/appendix/90-common-pitfalls.md)
...
| --- | --- | --- | --- |
| 默认配置加载 | [docs/part-01/01](../../docs/basics/spring-boot-basics/part-01-boot-basics/01-property-sources-and-profiles.md) | `BootBasicsDefaultLabTest` + `application.properties` | 默认 profile 与配置值来自哪里 |
| Profile 覆盖 | [docs/part-01/01](../../docs/basics/spring-boot-basics/part-01-boot-basics/01-property-sources-and-profiles.md) | `BootBasicsDevLabTest` + `application-dev.properties` | 为什么 dev 能覆盖默认配置 |
| 测试级覆盖优先级 | [docs/part-01/01](../../docs/basics/spring-boot-basics/part-01-boot-basics/01-property-sources-and-profiles.md) | `BootBasicsOverrideLabTest` | 为什么测试 properties 能覆盖文件配置 |
| 绑定与类型转换 | [docs/part-01/02](../../docs/basics/spring-boot-basics/part-01-boot-basics/02-configuration-properties-binding.md) | `AppProperties` + `BootBasicsDefaultLabTest` | string 配置如何变成 boolean/其他类型 |
