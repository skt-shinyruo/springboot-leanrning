...
!!! summary "章节学习卡片（怎么用这模块）"
    ...
    - 排障入口：`BootBasicsBranchMatrixLabTest` + [断点地图](004-02-breakpoint-map.md)
<!-- CHAPTER-CARD:END -->

<!-- GLOBAL-BOOK-NAV:START -->
上一章：[第 3 章：主线时间线：Spring Boot Basics（已迁移）](003-03-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 5 章：01：配置来源（PropertySources）与 Profile 覆盖](../part-01-boot-basics/005-01-property-sources-and-profiles.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
1. 先读：[配置来源与 Profiles](../part-01-boot-basics/005-01-property-sources-and-profiles.md)（把“谁覆盖谁”说清楚）
2. 再读：[`@ConfigurationProperties`](../part-01-boot-basics/006-02-configuration-properties-binding.md)（把“字符串配置”收敛成类型安全对象）
3. 最后对照：常见坑与自检（附录两章）

### 路线 B：排障/复现（更像带着问题翻手册）

- 先跑：`BootBasicsBranchMatrixLabTest`
- 再看：[断点地图](004-02-breakpoint-map.md)（用断点确认“最终值来自哪里”）
- 再对照：[关键分支矩阵](004-04-branch-decision-matrix.md)（把分支收敛成 If/Then）
