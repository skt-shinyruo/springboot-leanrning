...
上一章：[第 4 章：00 - Deep Dive Guide（springboot-basics）](004-00-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 4 章：04：关键分支矩阵（Branch Decision Matrix）](004-04-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
