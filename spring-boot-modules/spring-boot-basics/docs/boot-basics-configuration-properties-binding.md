...
上一章：[01. 配置来源（PropertySources）与 Profile 覆盖](boot-basics-property-sources-and-profiles.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 常见坑清单（建议反复对照）](appendix-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-01-boot-basics/01-property-sources-and-profiles.md](boot-basics-property-sources-and-profiles.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/90-common-pitfalls.md](appendix-common-pitfalls.md)
