...
@RestControllerAdvice(basePackages = "com.learning.springboot.bootwebmvc.part10_advice_matching")
@Order(100)
public class AdviceMatchingGlobalAdvice {
    ...
    public ResponseEntity<ApiError> handle(AdviceMatchingDemoException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ApiError("advice_global", Map.of("selector", "basePackages(part)")));
    }
}
