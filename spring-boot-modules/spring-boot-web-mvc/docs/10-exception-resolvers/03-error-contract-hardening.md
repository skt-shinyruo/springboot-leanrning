...
上一章：[02. 统一异常处理（ControllerAdvice）与“坏输入”](02-exception-handling.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. ExceptionResolvers（异常从哪来、又被谁“翻译”成状态码）](04-exception-resolvers-and-error-flow.md)
<!-- BOOKIFY:END -->
