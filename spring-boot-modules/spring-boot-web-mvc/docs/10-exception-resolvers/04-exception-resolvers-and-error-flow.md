...
上一章：[03. 错误契约加固（解析失败 vs 校验失败 vs 类型不匹配）](03-error-contract-hardening.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. ProblemDetail vs 自定义错误体（ApiError：契约的两种路线）](04-problemdetail-vs-custom-error.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- **安全链路（Security FilterChain）**
  ...
  - 参考：Security 与 MVC 相对位置（含边界 Lab）：[01-filterchain-security/01-security-filterchain-and-mvc.md](../01-filterchain-security/01-security-filterchain-and-mvc.md)
