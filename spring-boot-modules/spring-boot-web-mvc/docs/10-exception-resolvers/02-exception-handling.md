...
上一章：[03. HttpMessageConverter 与返回值处理（序列化发生在哪里）](../09-return-value-view/03-message-converters-and-return-values.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 错误契约加固（解析失败 vs 校验失败 vs 类型不匹配）](03-error-contract-hardening.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
更完整的 resolver 链解释见：
- [`04-exception-resolvers-and-error-flow.md`](04-exception-resolvers-and-error-flow.md)
