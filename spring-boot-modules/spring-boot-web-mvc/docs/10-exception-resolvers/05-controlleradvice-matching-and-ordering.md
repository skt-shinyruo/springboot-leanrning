...
上一章：[04. ProblemDetail vs 自定义错误体（ApiError：契约的两种路线）](04-problemdetail-vs-custom-error.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 错误页（error/*.html）与内容协商（Accept：HTML vs JSON）](../11-boot-error/03-error-pages-and-content-negotiation.md)
<!-- GLOBAL-BOOK-NAV:END -->
