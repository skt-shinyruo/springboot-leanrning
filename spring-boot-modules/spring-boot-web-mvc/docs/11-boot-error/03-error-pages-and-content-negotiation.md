...
上一章：[05. ControllerAdvice 的匹配与优先级（为什么 advice 生效/不生效）](../10-exception-resolvers/05-controlleradvice-matching-and-ordering.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Servlet Async（Callable）与测试（asyncDispatch）](../12-async-sse/01-servlet-async-and-testing.md)
<!-- BOOKIFY:END -->
