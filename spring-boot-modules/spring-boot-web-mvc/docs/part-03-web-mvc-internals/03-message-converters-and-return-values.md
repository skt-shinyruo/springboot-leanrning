...
上一章：[01. DispatcherServlet 主链路（把选路/参数解析/返回值/异常串起来）](01-dispatcherservlet-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. ExceptionResolvers（异常从哪来、又被谁“翻译”成状态码）](04-exception-resolvers-and-error-flow.md)
<!-- GLOBAL-BOOK-NAV:END -->
