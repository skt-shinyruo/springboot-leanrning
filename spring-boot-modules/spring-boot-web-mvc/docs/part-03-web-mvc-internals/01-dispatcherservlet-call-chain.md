...
上一章：[06. 断点地图（Part 01 Debugger Pack）](../part-00-guide/06-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. HttpMessageConverter 与返回值处理（序列化发生在哪里）](03-message-converters-and-return-values.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 章节：[05：Interceptor 的 async 生命周期（为什么会回调两次）](../part-01-web-mvc/05-interceptor-async-lifecycle.md)
