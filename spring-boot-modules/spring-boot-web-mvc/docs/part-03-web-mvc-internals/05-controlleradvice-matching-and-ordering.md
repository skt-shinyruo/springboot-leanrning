...
上一章：[04. ExceptionResolvers（异常从哪来、又被谁“翻译”成状态码）](04-exception-resolvers-and-error-flow.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 校验（Validation）与错误响应形状（Error Shape）](../part-01-web-mvc/01-validation-and-error-shaping.md)
<!-- GLOBAL-BOOK-NAV:END -->
