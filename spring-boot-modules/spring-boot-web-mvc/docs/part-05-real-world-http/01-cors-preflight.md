...
上一章：[01. Content Negotiation（406/415：Accept/Content-Type/produces/consumes）](../part-04-rest-contract/01-content-negotiation-406-415.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Servlet Async（Callable）与测试（asyncDispatch）](../part-06-async-sse/01-servlet-async-and-testing.md)
<!-- GLOBAL-BOOK-NAV:END -->
