...
上一章：[01. 传统 MVC 页面渲染入门（@Controller / ViewName / Thymeleaf）](01-thymeleaf-and-view-resolver.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. HttpMessageConverter 与返回值处理（序列化发生在哪里）](03-message-converters-and-return-values.md)
<!-- BOOKIFY:END -->
