...
上一章：[03. 请求绑定（Binding）与 Converter/Formatter](binding-validation-binding-and-converters.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Content Negotiation（406/415：Accept/Content-Type/produces/consumes）](message-conversion-content-negotiation-406-415.md)
<!-- GLOBAL-BOOK-NAV:END -->
