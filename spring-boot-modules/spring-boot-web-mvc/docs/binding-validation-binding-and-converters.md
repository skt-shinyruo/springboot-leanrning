...
- 校验机制（Bean Validation，机制正文与实验入口）：[`spring-core-validation/README.md`](../../../spring-core-modules/spring-core-validation/README.md)
- 类型转换（容器视角，ConversionService/TypeConverter/BeanWrapper）：`spring-core-modules/spring-core-beans/docs/wiring-type-conversion-and-beanwrapper.md`
