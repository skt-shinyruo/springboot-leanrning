...
上一章：[01. 传统 MVC 页面渲染入门（@Controller / ViewName / Thymeleaf）](../part-02-view-mvc/01-thymeleaf-and-view-resolver.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. CORS 与预检（OPTIONS：浏览器为什么要先问一句）](../part-05-real-world-http/01-cors-preflight.md)
<!-- GLOBAL-BOOK-NAV:END -->
