...
上一章：[01. Content Negotiation（406/415：Accept/Content-Type/produces/consumes）](01-content-negotiation-406-415.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Controller：边界、异常与契约的位置](../08-controller/01-controller-boundary.md)
<!-- BOOKIFY:END -->
