...
上一章：[03. 请求绑定（Binding）与 Converter/Formatter](03-binding-and-converters.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Content Negotiation（406/415：Accept/Content-Type/produces/consumes）](../07-message-conversion/01-content-negotiation-406-415.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
对应的机制内核解释见（建议按顺序）：
- [DispatcherServlet 主链路（把选路/参数解析/异常串起来）](../02-dispatcherservlet/01-dispatcherservlet-call-chain.md)
