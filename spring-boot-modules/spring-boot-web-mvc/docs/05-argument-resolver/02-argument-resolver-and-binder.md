...
上一章：[04. Interceptor 与 Filter：入口在哪里、顺序怎么理解](../04-handleradapter-interceptor/04-interceptor-and-filter-ordering.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 请求绑定（Binding）与 Converter/Formatter](../06-binding-validation/03-binding-and-converters.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
2. **自定义 Converter/Formatter（把 String 变成你的类型）**
   ...
   - 对应章节：[`06-binding-validation/03-binding-and-converters.md`](../06-binding-validation/03-binding-and-converters.md)
...
对应章节：[`07-message-conversion/01-content-negotiation-406-415.md`](../07-message-conversion/01-content-negotiation-406-415.md)
...
- ExceptionResolvers 与错误流：[`10-exception-resolvers/04-exception-resolvers-and-error-flow.md`](../10-exception-resolvers/04-exception-resolvers-and-error-flow.md)
