...
上一章：[01. CORS 与预检（OPTIONS：浏览器为什么要先问一句）](real-world-http-cors-preflight.md) ｜ 目录：[模块目录](../README.md) ｜ 下一章：[03. 下载与 Header（Content-Disposition / Content-Type / bytes）](real-world-http-download-and-streaming.md)
<!-- BOOKIFY:END -->
