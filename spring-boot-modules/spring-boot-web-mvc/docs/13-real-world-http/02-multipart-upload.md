...
上一章：[01. CORS 与预检（OPTIONS：浏览器为什么要先问一句）](01-cors-preflight.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 下载与 Header（Content-Disposition / Content-Type / bytes）](03-download-and-streaming.md)
<!-- BOOKIFY:END -->
