...
上一章：[03. 错误页（error/*.html）与内容协商（Accept：HTML vs JSON）](boot-error-error-pages-and-content-negotiation.md) ｜ 目录：[模块目录](../README.md) ｜ 下一章：[02. SSE（SseEmitter：text/event-stream 最小闭环）](async-sse-sse-emitter.md)
<!-- GLOBAL-BOOK-NAV:END -->
