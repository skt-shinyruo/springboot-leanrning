...
上一章：[05. Interceptor 的生命周期（sync vs async：为什么会“回调少了一截”）](../part-01-web-mvc/05-interceptor-async-lifecycle.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Content Negotiation（406/415：Accept/Content-Type/produces/consumes）](../part-04-rest-contract/01-content-negotiation-406-415.md)
<!-- GLOBAL-BOOK-NAV:END -->
