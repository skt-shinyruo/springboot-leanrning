...
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
    本章围绕01：知识地图（Web MVC Deep Dive Map）展开，主线可以概括为：HTTP 请求 → FilterChain → `DispatcherServlet#doDispatch` → HandlerMapping/HandlerAdapter → 参数解析与校验 → 视图/消息转换写回 → ExceptionResolvers 收敛错误。
...
上一章：[02. 00 - Deep Dive Guide（springboot-web-mvc）](02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[06. 断点地图（Part 01 Debugger Pack）](06-breakpoint-map.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-00-guide/00-deep-dive-guide.md](02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-web-mvc/01-validation-and-error-shaping.md](../part-01-web-mvc/01-validation-and-error-shaping.md)
