...
上一章：[第 62 章：Web MVC 请求主线](../README.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 00 - Deep Dive Guide（springboot-web-mvc）](02-deep-dive-guide.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
1. 先拿到全图：知道“问题可能出现在主线的哪一段”
   ...
   - 断点图：[02-breakpoint-map.md](06-breakpoint-map.md)
