...
上一章：[05. ControllerAdvice 的匹配与优先级（为什么 advice 生效/不生效）](../part-03-web-mvc-internals/05-controlleradvice-matching-and-ordering.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 统一异常处理（ControllerAdvice）与“坏输入”](02-exception-handling.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
对应的机制内核解释见（建议按顺序）：
- [DispatcherServlet 主链路（把选路/参数解析/异常串起来）](../part-03-web-mvc-internals/01-dispatcherservlet-call-chain.md)
- [ArgumentResolver 与 Binder（解析参数/绑定/校验触发点）](../part-03-web-mvc-internals/02-argument-resolver-and-binder.md)
- [ExceptionResolvers（异常从哪来、又被谁“翻译”成状态码）](../part-03-web-mvc-internals/04-exception-resolvers-and-error-flow.md)
...
上一章：[part-00-guide/00-deep-dive-guide.md](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-web-mvc/02-exception-handling.md](02-exception-handling.md)
