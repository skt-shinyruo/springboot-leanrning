...
上一章：[03. 请求绑定（Binding）与 Converter/Formatter](03-binding-and-converters.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. Interceptor 的生命周期（sync vs async：为什么会“回调少了一截”）](05-interceptor-async-lifecycle.md)
<!-- GLOBAL-BOOK-NAV:END -->
