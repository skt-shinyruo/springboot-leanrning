...
上一章：[01. Servlet Async（Callable）与测试（asyncDispatch）](01-servlet-async-and-testing.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. DeferredResult（回调式异步）与 timeout/fallback（可控分支）](03-deferredresult-and-timeout.md)
<!-- BOOKIFY:END -->
