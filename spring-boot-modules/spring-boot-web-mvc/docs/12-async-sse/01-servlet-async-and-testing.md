...
上一章：[03. 错误页（error/*.html）与内容协商（Accept：HTML vs JSON）](../11-boot-error/03-error-pages-and-content-negotiation.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. SSE（SseEmitter：text/event-stream 最小闭环）](02-sse-emitter.md)
<!-- GLOBAL-BOOK-NAV:END -->
