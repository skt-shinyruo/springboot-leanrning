...
上一章：[05. 知识地图（Web MVC Deep Dive Map）](../00-guide/05-knowledge-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. 关键分支矩阵（Web MVC Branch Decision Matrix）](04-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- DispatcherServlet 主链路：`02-dispatcherservlet/01-dispatcherservlet-call-chain.md`
- resolver/binder：`05-argument-resolver/02-argument-resolver-and-binder.md`
- converter：`09-return-value-view/03-message-converters-and-return-values.md`
- resolvers：`10-exception-resolvers/04-exception-resolvers-and-error-flow.md`
