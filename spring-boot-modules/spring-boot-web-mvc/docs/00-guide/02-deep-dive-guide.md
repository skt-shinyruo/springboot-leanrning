# 02. 00 - Deep Dive Guide（springboot-web-mvc）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
    本章围绕Deep Dive Guide（springboot-web-mvc）展开，主线可以概括为：HTTP 请求 → FilterChain → `DispatcherServlet#doDispatch` → HandlerMapping/HandlerAdapter → 参数解析与校验 → 视图/消息转换写回 → ExceptionResolvers 收敛错误。
...
上一章：[01. 主线时间线：Spring Boot Web MVC](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. 知识地图（Web MVC Deep Dive Map）](05-knowledge-map.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
## 推荐阅读顺序
1. [01-validation-and-error-shaping](../06-binding-validation/01-validation-and-error-shaping.md)
2. [02-exception-handling](../10-exception-resolvers/02-exception-handling.md)
3. [03-binding-and-converters](../06-binding-validation/03-binding-and-converters.md)
4. [04-interceptor-and-filter-ordering](../04-handleradapter-interceptor/04-interceptor-and-filter-ordering.md)
5. [01-knowledge-map](05-knowledge-map.md)
6. [01-dispatcherservlet-call-chain](../02-dispatcherservlet/01-dispatcherservlet-call-chain.md)
7. [02-argument-resolver-and-binder](../05-argument-resolver/02-argument-resolver-and-binder.md)
8. [03-message-converters-and-return-values](../09-return-value-view/03-message-converters-and-return-values.md)
9. [01-content-negotiation-406-415](../07-message-conversion/01-content-negotiation-406-415.md)
10. [02-jackson-objectmapper-controls](../07-message-conversion/02-jackson-objectmapper-controls.md)
11. [03-error-contract-hardening](../10-exception-resolvers/03-error-contract-hardening.md)
12. [01-cors-preflight](../13-real-world-http/01-cors-preflight.md)
13. [02-multipart-upload](../13-real-world-http/02-multipart-upload.md)
14. [03-download-and-streaming](../13-real-world-http/03-download-and-streaming.md)
15. [04-static-resources-and-cache](../13-real-world-http/04-static-resources-and-cache.md)
16. [01-servlet-async-and-testing](../12-async-sse/01-servlet-async-and-testing.md)
17. [02-sse-emitter](../12-async-sse/02-sse-emitter.md)
18. [01-webmvc-testing-and-troubleshooting](../14-testing-observability/01-webmvc-testing-and-troubleshooting.md)
19. [01-security-filterchain-and-mvc](../01-filterchain-security/01-security-filterchain-and-mvc.md)
20. [02-observability-and-metrics](../14-testing-observability/02-observability-and-metrics.md)
21. [01-thymeleaf-and-view-resolver](../09-return-value-view/01-thymeleaf-and-view-resolver.md)
22. [02-form-binding-validation-prg](../09-return-value-view/02-form-binding-validation-prg.md)
23. [03-error-pages-and-content-negotiation](../11-boot-error/03-error-pages-and-content-negotiation.md)
24. [90-common-pitfalls](../appendix/01-common-pitfalls.md)
25. [99-self-check](../appendix/02-self-check.md)
