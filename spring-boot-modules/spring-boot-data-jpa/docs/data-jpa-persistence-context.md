...
上一章：[01. Entity 状态机：transient / managed / detached / removed](data-jpa-entity-states.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. flush：SQL 什么时候发出去？为什么 flush 后 JDBC 能查到？](data-jpa-flush-and-visibility.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
学习阶段强烈建议在关键断言前后配合 `flush()` 与 `clear()`，避免被一级缓存制造的“假象”带偏
...
上一章：[part-01-data-jpa/01-entity-states.md](data-jpa-entity-states.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-data-jpa/03-flush-and-visibility.md](data-jpa-flush-and-visibility.md)
