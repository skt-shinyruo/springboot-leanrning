...
上一章：[04. 断点地图（Data JPA Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Entity 状态机：transient / managed / detached / removed](data-jpa-entity-states.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 97 章：01. Entity 状态机：transient / managed / detached / removed](data-jpa-entity-states.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-data-jpa/01-entity-states.md](data-jpa-entity-states.md)
