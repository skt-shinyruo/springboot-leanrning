...
上一章：[01. 主线时间线：Spring Boot Data JPA](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Entity 状态机：transient / managed / detached / removed](../part-01-data-jpa/01-entity-states.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**02. 00 - Deep Dive Guide（springboot-data-jpa）**
...
8. [90-common-pitfalls](../appendix/01-common-pitfalls.md)
9. [99-self-check](../appendix/02-self-check.md)
