...
上一章：[02. Persistence Context：JPA 的“一级缓存”与事务绑定](02-persistence-context.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. Dirty Checking（脏检查）：为什么改字段不用 save 也能落库？](04-dirty-checking.md)
<!-- GLOBAL-BOOK-NAV:END -->
