...
上一章：[第 96 章：00 - Deep Dive Guide（springboot-data-jpa）](../part-00-guide/096-00-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 98 章：02. Persistence Context：JPA 的“一级缓存”与事务绑定](098-02-persistence-context.md)
<!-- GLOBAL-BOOK-NAV:END -->
