...
上一章：[第 100 章：04. Dirty Checking（脏检查）：为什么改字段不用 save 也能落库？](100-04-dirty-checking.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 102 章：06. `@DataJpaTest`：为什么它适合学 JPA（切片测试）](102-06-datajpatest-slice.md)
<!-- GLOBAL-BOOK-NAV:END -->
