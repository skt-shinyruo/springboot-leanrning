...
上一章：[06. `@DataJpaTest`：为什么它适合学 JPA（切片测试）](06-datajpatest-slice.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 常见坑清单（建议反复对照）](../appendix/01-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-01-data-jpa/06-datajpatest-slice.md](06-datajpatest-slice.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/90-common-pitfalls.md](../appendix/01-common-pitfalls.md)
