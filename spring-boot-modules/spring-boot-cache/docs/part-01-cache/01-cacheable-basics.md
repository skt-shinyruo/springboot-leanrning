...
上一章：[02. 00 - Deep Dive Guide（springboot-cache）](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. `@CachePut/@CacheEvict`：更新与失效](02-cacheput-and-evict.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 如果怀疑 key 不对：先去下一章（key/SpEL），把维度写成断言再回来
...
上一章：[part-00-guide/00-deep-dive-guide.md](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-cache/02-cacheput-and-evict.md](02-cacheput-and-evict.md)
