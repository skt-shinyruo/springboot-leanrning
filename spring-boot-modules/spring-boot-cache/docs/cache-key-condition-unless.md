...
上一章：[02. `@CachePut/@CacheEvict`：更新与失效](cache-cacheput-and-evict.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. `sync=true`：防缓存击穿（stampede）](cache-sync-stampede.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
修法也很朴素：把“前置过滤”和“结果过滤”分开设计，并用测试把分支锁定。
...
上一章：[part-01-cache/02-cacheput-and-evict.md](cache-cacheput-and-evict.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-cache/04-sync-stampede.md](cache-sync-stampede.md)
