...
上一章：[04. 断点地图（Cache Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. `@Cacheable` 最小闭环](cache-cacheable-basics.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 109 章：01：@Cacheable 基础与命中语义](cache-cacheable-basics.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-cache/01-cacheable-basics.md](cache-cacheable-basics.md)
