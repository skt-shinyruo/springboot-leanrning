...
上一章：[02. 00 - Deep Dive Guide（springboot-business-case）](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 90 - Common Pitfalls（springboot-business-case）](appendix-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
