...
- 先完成：`spring-boot-web-mvc`、`spring-boot-data-jpa`、`spring-core-tx`、`spring-core-events`、`spring-core-aop`
...
- Solutions（练习 答案回归）：`mvn -q -pl :spring-boot-business-case -Dtest=*ExerciseSolutionTest test`
