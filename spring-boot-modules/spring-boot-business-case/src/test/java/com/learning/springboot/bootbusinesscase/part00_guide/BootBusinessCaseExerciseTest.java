    ...
    void exercise_checkedExceptionRollbackRule() {
        assertThat(true)
                .as("""
                        ...
                        - `spring-core-modules/spring-core-tx/docs/part-01-transaction-basics/01-transaction-boundary.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_selfInvocationPitfall() {
        assertThat(true)
                .as("""
                        ...
                        - `spring-core-modules/spring-core-tx/docs/part-01-transaction-basics/02-transactional-proxy.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_transactionalEventAfterRollback() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-events/docs/part-02-async-and-transactional/03-transactional-event-listener.md`
                        """)
                .isFalse();
    }
}
