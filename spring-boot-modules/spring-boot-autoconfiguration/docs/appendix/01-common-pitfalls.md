...
上一章：[01. 条件装配与 backoff（为什么它“有时生效、有时不生效”）](../part-01-autoconfig-basics/01-conditional-and-backoff.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 99 - Self Check（springboot-autoconfiguration）](02-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-01-autoconfig-basics/01-conditional-and-backoff.md](../part-01-autoconfig-basics/01-conditional-and-backoff.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/99-self-check.md](02-self-check.md)
