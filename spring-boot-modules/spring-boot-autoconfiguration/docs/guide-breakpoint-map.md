...
上一章：[03. AutoConfiguration 调用链（imports → 条件决策 → 产出 bean）](guide-autoconfiguration-import-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. 关键分支矩阵（AutoConfiguration）](guide-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 195 章：04：关键分支矩阵](guide-branch-decision-matrix.md)
...
上一章：[part-00-guide/01-autoconfiguration-call-chain.md](guide-autoconfiguration-import-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-00-guide/04-branch-decision-matrix.md](guide-branch-decision-matrix.md)
