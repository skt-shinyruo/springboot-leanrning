...
上一章：[04. 断点地图（AutoConfiguration Debugger Pack）](04-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 条件装配与 backoff（为什么它“有时生效、有时不生效”）](../part-01-autoconfig-basics/01-conditional-and-backoff.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-00-guide/02-breakpoint-map.md](04-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-autoconfig-basics/01-conditional-and-backoff.md](../part-01-autoconfig-basics/01-conditional-and-backoff.md)
