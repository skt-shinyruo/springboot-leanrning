...
上一章：[Docs TOC](../README.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 深挖导读：把“自动配置导入 + 条件决策”落到源码与断点](guide-deep-dive-guide.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
3. [02. 断点地图（Debugger Pack）](guide-breakpoint-map.md)
...
下一章见：[第 195 章：00. 深挖导读](guide-deep-dive-guide.md)
