...
这个页面用于承接“模块文档”的总入口：你可以按主题找到每个模块的 **概览页（README）**，再通过侧边栏进入 `part-*` 与 `appendix/` 的深挖章节。

> 提示：如果你希望“像看书一样顺读”，推荐走侧边栏的「主线之书（Book）」；模块文档更适合查机制细节、边界条件与排障。
...
- IoC / Bean：[`spring-core-beans`](../beans/spring-core-beans/README.md)
- AOP（含 weaving）：
  - [`spring-core-aop`](../aop/spring-core-aop/README.md)
  - [`spring-core-aop-weaving`](../aop/spring-core-aop-weaving/README.md)
- 事务（Tx）：[`spring-core-tx`](../tx/spring-core-tx/README.md)
- Events：[`spring-core-events`](../events/spring-core-events/README.md)
...
- 目录与阅读方法：[`docs/book/index.md`](../book/index.md)

<!-- END AUTO TOPICS PAGE -->
