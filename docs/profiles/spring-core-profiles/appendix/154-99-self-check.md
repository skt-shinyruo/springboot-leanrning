...
上一章：[第 153 章：常见坑（Spring Core Profiles）](153-90-common-pitfalls.md) ｜ 全书目录：[Book TOC](../../../book/index.md) ｜ 下一章：[第 155 章：Validation 主线](../../../book/155-validation-mainline.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读
<!-- BOOKLIKE-V2:INTRO:START -->
这一章围绕「自测题（Spring Core Profiles）」展开：先把边界说清楚，再沿主线推进到关键分支，最后用可运行入口把结论验证出来。
...
- Lab：`SpringCoreProfilesLabTest` / `SpringCoreProfilesBookMatrixLabTest` / `SpringCoreProfilesBranchMatrixLabTest` / `SpringCoreProfilesProfilePrecedenceLabTest`

上一章：[常见坑](153-90-common-pitfalls.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[Docs TOC](../README.md)
