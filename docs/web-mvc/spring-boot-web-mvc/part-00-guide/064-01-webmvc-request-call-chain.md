# 第 64 章：01：请求调用链速览（从 FilterChain 到 DispatcherServlet#doDispatch）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[第 64 章：00 - Deep Dive Guide（springboot-web-mvc）](064-00-deep-dive-guide.md) ｜ 全书目录：[Book TOC](../../../book/index.md) ｜ 下一章：[第 64 章：04 - Branch/Decision Matrix（springboot-web-mvc）](064-04-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**01：请求调用链速览（从 FilterChain 到 DispatcherServlet#doDispatch）**
...
- 备注：本章是“速览与定位”，详版调用链请读：
  - [DispatcherServlet 主链路（详）](../part-03-web-mvc-internals/067-01-dispatcherservlet-call-chain.md)
  - [异常收敛与错误流（详）](../part-03-web-mvc-internals/069-04-exception-resolvers-and-error-flow.md)
...
>
> - 断点地图：`part-00-guide/066-02-breakpoint-map.md`
...
- 观察点 1：运行本章推荐入口后，聚焦「01：请求调用链速览（从 FilterChain 到 DispatcherServlet#doDispatch）」的生效时机/顺序/边界；断点/入口：（以本章正文“源码；断言：你能解释“为什么此处生效/为什么此处不生效”。
- 观察点 2：运行本章推荐入口后，聚焦「01：请求调用链速览（从 FilterChain 到 DispatcherServlet#doDispatch）」的生效时机/顺序/边界；断点/入口：断点”小节为准）；断言：你能解释“为什么此处生效/为什么此处不生效”。
- 建议：跑完 ``BootWebMvcLabTest`` 后，把上述观察点逐条对照，写出你自己的 1–2 句结论（可复述）。
...
- Lab：`BootWebMvcLabTest` / `BootWebMvcErrorBranchMatrixLabTest` / `BootWebMvcInternalsLabTest` / `BootWebMvcTraceLabTest`

上一章：[066-02-breakpoint-map.md](066-02-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[064-04-branch-decision-matrix.md](064-04-branch-decision-matrix.md)
