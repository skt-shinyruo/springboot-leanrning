...
上一章：[02. 深挖指南（Spring Core Resources）](guide-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. 断点地图（Resources Debugger Pack）](guide-breakpoint-map.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 140 章：02：断点地图](guide-breakpoint-map.md)
