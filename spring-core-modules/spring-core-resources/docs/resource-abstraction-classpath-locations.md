...
上一章：[01. `Resource` 抽象：为什么 Spring 不直接使用 `File`？](resource-abstraction.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. `classpath*:` 与 pattern：为什么它能“扫到多个资源”？](resource-abstraction-classpath-star-and-pattern.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[01-resource-abstraction](resource-abstraction.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03-classpath-star-and-pattern](resource-abstraction-classpath-star-and-pattern.md)
