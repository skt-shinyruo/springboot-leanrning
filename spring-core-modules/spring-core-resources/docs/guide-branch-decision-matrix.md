...
上一章：[04. 断点地图（Resources Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. `Resource` 抽象：为什么 Spring 不直接使用 `File`？](resource-abstraction.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 141 章：01：Resource 抽象：拿到的到底是什么](resource-abstraction.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-resource-abstraction/01-resource-abstraction.md](resource-abstraction.md)
