# 第 140 章：01：Resources 调用链（ResourceLoader → Resource → 读取）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[第 140 章：00. 深挖导读](140-00-deep-dive-guide.md) ｜ 全书目录：[Book TOC](../../../book/index.md) ｜ 下一章：[第 140 章：02：断点地图](140-02-breakpoint-map.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-00-guide/00-deep-dive-guide.md](140-00-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-00-guide/02-breakpoint-map.md](140-02-breakpoint-map.md)
