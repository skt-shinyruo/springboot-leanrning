...
上一章：[04. 断点地图（Spring Tx Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 事务边界（Transaction Boundary）：究竟在“保护”哪一段代码？](transaction-basics-transaction-boundary.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 54 章：01：事务边界：什么情况下“算在一个事务里”](transaction-basics-transaction-boundary.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-transaction-basics/01-transaction-boundary.md](transaction-basics-transaction-boundary.md)
