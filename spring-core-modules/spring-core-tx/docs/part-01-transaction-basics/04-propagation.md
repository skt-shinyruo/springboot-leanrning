...
上一章：[03. 回滚规则：为什么 checked exception 默认不回滚？](03-rollback-rules.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 程序化事务：为什么 `TransactionTemplate` 在学习阶段很有价值？](../part-02-template-and-debugging/01-transaction-template.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[03-rollback-rules](03-rollback-rules.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05-transaction-template](../part-02-template-and-debugging/01-transaction-template.md)
