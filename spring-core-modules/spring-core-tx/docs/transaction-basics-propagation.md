...
上一章：[03. 回滚规则：为什么 checked exception 默认不回滚？](transaction-basics-rollback-rules.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 程序化事务：为什么 `TransactionTemplate` 在学习阶段很有价值？](template-and-debugging-transaction-template.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[03-rollback-rules](transaction-basics-rollback-rules.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05-transaction-template](template-and-debugging-transaction-template.md)
