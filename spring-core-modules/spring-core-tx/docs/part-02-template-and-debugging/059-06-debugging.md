...
上一章：[第 58 章：05. 程序化事务：为什么 `TransactionTemplate` 在学习阶段很有价值？](058-05-transaction-template.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 60 章：90. 常见坑清单（建议反复对照）](../appendix/060-90-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
