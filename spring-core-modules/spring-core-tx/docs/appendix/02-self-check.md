...
上一章：[01. 常见坑清单（建议反复对照）](01-common-pitfalls.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 62 章：Web MVC 请求主线](../README.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- Fix：把“行数变化/标签写入”作为最终证据链（本模块 tests 已提供），先锁定事实再讨论机制
