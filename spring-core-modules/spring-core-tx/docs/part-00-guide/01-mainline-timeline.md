...
上一章：[第 51 章：事务主线（Tx）](../README.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 深挖指南（Spring Core Tx）](02-deep-dive-guide.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
5. 当不想要注解：TransactionTemplate 的“显式边界”
   - 阅读：[05. TransactionTemplate](../part-02-template-and-debugging/01-transaction-template.md)
6. 最后学会调试：先能把“有没有进拦截器、拿到的是什么事务”看见
   - 阅读：[06. 调试](../part-02-template-and-debugging/02-debugging.md)
