    ...
    <!-- CHAPTER-CARD:START -->
    !!! summary "章节入口"
        - 这页只做支持：把误区映射到 owner 文档，不解释 owner 的正文。
        - 需要机制解释时，跳回主文档。
    ...
    把误区映射到 owner 文档，不解释 owner 的正文。

    ## 路由表

    | 入口 | 用途 |
    | --- | --- |
    | [dependency-injection-resolution.md](dependency-injection-resolution.md) | 主文档或支持入口 |
| [proxying-phase.md](proxying-phase.md) | 主文档或支持入口 |
| [circular-dependency.md](circular-dependency.md) | 主文档或支持入口 |
