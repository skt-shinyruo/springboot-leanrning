...
上一章：[06. 生命周期回调顺序：Aware / BPP / init / destroy（以及 prototype 为什么不销毁）](06-lifecycle-callback-order.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Lazy：lazy-init bean vs `@Lazy` 注入点（懒代理）](../part-04-wiring-and-boundaries/01-lazy-semantics.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 后处理器与顺序：[03-post-processor-ordering.md](03-post-processor-ordering.md)
- BDRPP 注册与定义扩张：[02-bdrpp-definition-registration.md](02-bdrpp-definition-registration.md)
- 预实例化短路：[04-pre-instantiation-short-circuit.md](04-pre-instantiation-short-circuit.md)
- early reference 与循环依赖：[05-early-reference-and-circular.md](05-early-reference-and-circular.md)
- 生命周期回调顺序：[06-lifecycle-callback-order.md](06-lifecycle-callback-order.md)
...
上一章：[17. 生命周期回调顺序：Aware / BPP / init / destroy（以及 prototype 为什么不销毁）](06-lifecycle-callback-order.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 23 章：18. Lazy：lazy-init bean vs `@Lazy` 注入点（懒代理）](../part-04-wiring-and-boundaries/01-lazy-semantics.md)
