...
上一章：[17. `@Value("${...}")` 占位符解析：默认 non-strict vs strict fail-fast](17-value-placeholder-resolution-strict-vs-non-strict.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[19. 类型转换：BeanWrapper / ConversionService / PropertyEditor 的边界](19-type-conversion-and-beanwrapper.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
可以把它和 [00 章](../part-00-guide/03-deep-dive-guide.md) 的时间线对上：
...
- 注解为什么能工作（基础设施处理器）：[12](../part-03-container-internals/01-container-bootstrap-and-infrastructure.md)
- 注入发生在哪个阶段：`postProcessProperties`： [30](13-injection-phase-field-vs-constructor.md)
- 生命周期回调顺序： [17](../part-03-container-internals/06-lifecycle-callback-order.md)
...
## 1. 最小实验：用一个可断言的 Lab 将 merged 过程复现出来
...
上一章：[34. @Value 占位符解析：strict vs non-strict](17-value-placeholder-resolution-strict-vs-non-strict.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[36. 类型转换：BeanWrapper / ConversionService / PropertyEditor 的边界](19-type-conversion-and-beanwrapper.md)
