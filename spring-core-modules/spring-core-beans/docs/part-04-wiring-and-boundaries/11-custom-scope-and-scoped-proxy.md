...
- “调试时看到的类型是 proxy，不是目标类” → **实例层（代理语义）**：这是 scoped proxy 的预期形态（对照 [31](14-proxying-phase-bpp-wraps-bean.md)）
...
上一章：[27. SmartLifecycle：phase 与 start/stop 顺序](10-smart-lifecycle-phase.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[29. FactoryBean 边界误区：泛型/代理/对象类型推断](12-factorybean-edge-cases.md)
