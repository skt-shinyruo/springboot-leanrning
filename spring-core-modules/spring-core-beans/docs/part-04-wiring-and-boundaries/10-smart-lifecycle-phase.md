...
上一章：[09. SmartInitializingSingleton：所有单例都创建完之后再做事](09-smart-initializing-singleton.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[11. 自定义 Scope + scoped proxy：thread scope 的真实语义](11-custom-scope-and-scoped-proxy.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[26. SmartInitializingSingleton：容器就绪后回调](09-smart-initializing-singleton.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[28. 自定义 scope 与 scoped proxy：线程 scope 复现](11-custom-scope-and-scoped-proxy.md)
