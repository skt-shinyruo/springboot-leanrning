...
上一章：[07. BeanDefinition 覆盖（overriding）：同名 bean 是“最后一个赢”还是“直接失败”？](07-bean-definition-overriding.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[09. SmartInitializingSingleton：所有单例都创建完之后再做事](09-smart-initializing-singleton.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[24. BeanDefinition 覆盖：同名定义的冲突策略](07-bean-definition-overriding.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[26. SmartInitializingSingleton：容器就绪后回调](09-smart-initializing-singleton.md)
