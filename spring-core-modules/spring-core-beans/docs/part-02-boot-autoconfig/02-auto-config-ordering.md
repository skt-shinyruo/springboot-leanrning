...
上一章：[08. 循环依赖：现象、原因与规避（constructor vs setter）](../part-01-ioc-container/08-circular-dependencies.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. Spring Boot 自动装配如何影响 Bean（Auto-configuration）](03-spring-boot-auto-configuration.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[09. 循环依赖：现象、原因与规避（constructor vs setter）](../part-01-ioc-container/08-circular-dependencies.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[10. Spring Boot 自动装配如何影响 Bean（Auto-configuration）](03-spring-boot-auto-configuration.md)
