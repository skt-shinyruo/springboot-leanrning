...
3) 注册入口：`SpringCoreBeansBootstrapInternalsLabTest`（配合 [02](../part-01-ioc-container/01-bean-registration.md)）
...
模板对照：`appendix/04-interview-playbook.md`
...
上一章：[99. 团队内训讲义（Training Kit）：可直接用于授课的课时脚本](10-team-training-kit.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[Docs TOC](../README.md)
