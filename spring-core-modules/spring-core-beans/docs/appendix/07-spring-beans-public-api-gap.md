# 07. spring-beans Public API Gap 清单（按包/机制域分批深化）
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[06. <!--](06-spring-beans-public-api-index.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[08. Explore/Debug 用例（可选启用，不影响默认回归）](08-explore-debug-tests.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 本章主题：**07. spring-beans Public API Gap 清单（按包/机制域分批深化）**
...
!!! summary "本章要点"
    ...
    - 当读者发现某个 API/机制不在主线章节里：先在 [95](06-spring-beans-public-api-index.md) 查索引定位，再回到本章看是否已覆盖。
...
1) 在 [95](06-spring-beans-public-api-index.md) 定位目标 API 包/类
...
- 下一章：[97. Explore/Debug 用例（可选启用，不影响默认回归）](08-explore-debug-tests.md)

<!-- BOOKIFY:START -->

上一章：[95. spring-beans Public API Index（索引）](06-spring-beans-public-api-index.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[97. Explore/Debug 用例（可选启用，不影响默认回归）](08-explore-debug-tests.md)
