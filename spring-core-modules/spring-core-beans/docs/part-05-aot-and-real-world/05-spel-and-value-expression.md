...
- 占位符 strict vs non-strict： [34](../part-04-wiring-and-boundaries/17-value-placeholder-resolution-strict-vs-non-strict.md)
- 类型转换边界： [36](../part-04-wiring-and-boundaries/19-type-conversion-and-beanwrapper.md)
...
上一章：[43. 容器外对象注入：AutowireCapableBeanFactory](04-autowirecapablebeanfactory-external-objects.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[45. 自定义 Qualifier：meta-annotation 与候选收敛](06-custom-qualifier-meta-annotation.md)
