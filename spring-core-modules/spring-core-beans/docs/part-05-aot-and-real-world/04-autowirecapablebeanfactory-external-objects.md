# 04. 容器外对象注入：AutowireCapableBeanFactory
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[03. XML → BeanDefinitionReader：定义层解析与错误分型](03-xml-bean-definition-reader.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. SpEL 与 `@Value("#{...}")`：表达式解析链路](05-spel-and-value-expression.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- [25. 手工添加 BeanPostProcessor：顺序与 Ordered 的陷阱](../part-04-wiring-and-boundaries/08-programmatic-bpp-registration.md)
- [05. 初始化、销毁与回调](../part-01-ioc-container/04-lifecycle-and-callbacks.md)
...
上一章：[42. XML → BeanDefinitionReader：定义层解析与错误分型](03-xml-bean-definition-reader.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[44. SpEL 与 `@Value("#{...}")`：表达式解析链路](05-spel-and-value-expression.md)
