# 08. BeanDefinitionReader：除了注解与 XML，还有 Properties / Groovy
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"
...
上一章：[07. XML namespace 扩展：NamespaceHandler / Parser / spring.handlers](07-xml-namespace-extension.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[09. 方法注入（Method Injection）：replaced-method / MethodReplacer](09-method-injection-replaced-method.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 本章主题：**08. BeanDefinitionReader：除了注解与 XML，还有 Properties / Groovy**
...
| 现象 | 更接近失败在哪一段 | 证据（断点/观察点） | 修复思路 | 验证方式（本仓库） |
| --- | --- | --- | --- | --- |
...
| 误以为这是“创建失败” | 尚未进入创建阶段 | 先证明是否进入 `preInstantiateSingletons/doCreateBean` | 先把问题分型为“定义层 vs 实例层”再排查 | 结合 [18](../part-03-container-internals/07-refresh-to-bean-creation-mainline.md) 主线 |
...
上一章：[46. XML namespace 扩展：NamespaceHandler / Parser / spring.handlers](07-xml-namespace-extension.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[48. 方法注入：replaced-method / MethodReplacer（实例化策略分支）](09-method-injection-replaced-method.md)
