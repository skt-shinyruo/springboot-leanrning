...
建议优先运行 `SpringCoreBeansXmlBeanDefinitionReaderLabTest`（或文末“对应 Lab/Test”中的最小入口），再回到正文逐段对照分支与原因。
...
上一章：[41. RuntimeHints 入门：把构建期契约完成验证](02-runtimehints-basics.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[43. 容器外对象注入：AutowireCapableBeanFactory](04-autowirecapablebeanfactory-external-objects.md)
