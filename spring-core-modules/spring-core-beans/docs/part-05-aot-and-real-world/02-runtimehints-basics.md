...
上一章：[01. AOT / Native 总览：为什么“JVM 可运行”不等于“Native 可运行”](01-aot-and-native-overview.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. XML → BeanDefinitionReader：定义层解析与错误分型](03-xml-bean-definition-reader.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[40. AOT / Native 总览：为什么“JVM 可运行”不等于“Native 可运行”](01-aot-and-native-overview.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[42. XML → BeanDefinitionReader：定义层解析与错误分型](03-xml-bean-definition-reader.md)
