    # Guide：ApplicationContext refresh 调用链
    <!-- CHAPTER-CARD:START -->
    !!! summary "章节入口"
        - 这页只做支持：把 refresh 相关问题路由到 `refresh-mainline.md`、`container-bootstrap-and-infrastructure.md` 和 `bean-creation-mainline.md`。
        - 需要机制解释时，跳回主文档。
    ...
    把 refresh 相关问题路由到 `refresh-mainline.md`、`container-bootstrap-and-infrastructure.md` 和 `bean-creation-mainline.md`。
...
| [container-bootstrap-and-infrastructure.md](container-bootstrap-and-infrastructure.md) | 主文档或支持入口 |
