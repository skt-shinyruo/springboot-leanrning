...
上一章：[05. 30 分钟快速闭环：先快后深（3 个最小实验入口）](05-quickstart-30min.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 依赖注入解析：类型/名称/@Qualifier/@Primary](../part-01-ioc-container/02-dependency-injection-resolution.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
> 快速入口：若不确定该从哪组断点开始，可先用“现象 → 断点组”选一个起点，再回到 [知识地图](../appendix/03-knowledge-map.md) 补齐“章节 + 推荐 Lab”。
...
上一章：[part-00-guide/01-quickstart-30min.md](05-quickstart-30min.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-ioc-container/01-bean-mental-model.md](../part-01-ioc-container/09-bean-mental-model.md)
...
推荐复习入口：`appendix/04-interview-playbook.md` / `appendix/09-debugger-pack.md`
