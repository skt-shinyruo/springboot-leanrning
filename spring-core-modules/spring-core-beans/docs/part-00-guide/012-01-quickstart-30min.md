...
上一章：[00. 深潜指南（如何读/如何断点/如何建立肌肉记忆）](011-00-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Bean 运行机制：从 BeanDefinition 到最终暴露对象](../part-01-ioc-container/020-01-bean-mental-model.md)
