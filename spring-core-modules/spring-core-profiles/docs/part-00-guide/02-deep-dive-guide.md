...
上一章：[01. 主线时间线：Spring Profiles](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. Profile 激活与 Bean 选择](../part-01-profiles/01-profile-activation-and-bean-selection.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**02. 深挖指南（Spring Core Profiles）**
