...
上一章：[01. 常见坑（Spring Core Profiles）](01-common-pitfalls.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 155 章：Validation 主线](../README.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

本章是「自测题（Spring Core Profiles）」的自检与复盘页：不引入新概念，而是把关键分支以问题的形式回放。
建议先运行 `SpringCoreProfilesLabTest`（或本章列出的 Matrix/Lab 入口），再按题目逐一回到对应的证据链。
...
- 本章主题：**02. 自测题（Spring Core Profiles）**
