...
上一章：[01. Profile 激活与 Bean 选择](profiles-profile-activation-and-bean-selection.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 自测题（Spring Core Profiles）](appendix-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[01-profile-activation-and-bean-selection](profiles-profile-activation-and-bean-selection.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[99-self-check](appendix-self-check.md)
