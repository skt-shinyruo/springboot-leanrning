...
上一章：[第 126 章：Events 主线](../README.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 深挖指南（Spring Core Events）](02-deep-dive-guide.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
5. 异步监听：从 @AsyncListener 到 multicaster 的线程模型
   - 阅读：[05. 异步监听](../part-02-async-and-transactional/01-async-listener.md)
   - 阅读：[06. 异步 multicaster](../part-02-async-and-transactional/02-async-multicaster.md)
6. 事务事件：什么时候触发、提交/回滚会怎么影响执行
   - 阅读：[07. 事务事件监听](../part-02-async-and-transactional/03-transactional-event-listener.md)
