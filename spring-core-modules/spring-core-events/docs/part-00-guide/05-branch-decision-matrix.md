...
上一章：[04. 断点地图（Spring Events Debugger Pack）](04-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 事件心智模型：发布（publish）与订阅（listen）到底在解耦什么？](../part-01-event-basics/01-event-mental-model.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[part-00-guide/02-breakpoint-map.md](04-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-event-basics/01-event-mental-model.md](../part-01-event-basics/01-event-mental-model.md)
