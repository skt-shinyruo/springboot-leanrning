...
上一章：[03. condition 与 payload：监听器为什么能“按条件触发”甚至接收普通对象？](03-condition-and-payload.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 异步监听器：`@Async` 生效需要什么？线程会怎么变？](../part-02-async-and-transactional/01-async-listener.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 这个动作如果失败，是否应该让主流程失败？
  - 应该：同步事件 + 异常传播是合理的
  - 不应该：考虑异步/隔离（见 [05. async-listener](../part-02-async-and-transactional/01-async-listener.md) 与 [06. async-multicaster](../part-02-async-and-transactional/02-async-multicaster.md)）
...
上一章：[03-condition-and-payload](03-condition-and-payload.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05-async-listener](../part-02-async-and-transactional/01-async-listener.md)
