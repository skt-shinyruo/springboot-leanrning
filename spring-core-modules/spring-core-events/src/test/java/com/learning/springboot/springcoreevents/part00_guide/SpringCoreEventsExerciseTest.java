    ...
    void exercise_multipleListeners() {
        ...
        assertThat(entries)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-events/docs/event-basics-multiple-listeners-and-order.md`
                        """)
    ...
    void exercise_asyncListener() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-events/docs/async-and-transactional-async-listener.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_asyncMulticaster() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-events/docs/async-and-transactional-async-multicaster.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_conditionalListener() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-events/docs/event-basics-condition-and-payload.md`
                        """)
                .isFalse();
    }
}
