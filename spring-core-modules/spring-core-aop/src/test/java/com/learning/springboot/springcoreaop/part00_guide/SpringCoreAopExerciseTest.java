        ...
        assertThat(invocationLog.count())
                .as("""
                        ...
                        1) 先读“自调用陷阱”与 exposeProxy：
                           ...
                           - `spring-core-modules/spring-core-aop/docs/part-01-proxy-fundamentals/034-05-expose-proxy.md`
    ...
    void exercise_addOrderedAspect() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-aop/docs/part-01-proxy-fundamentals/035-06-debugging.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_switchToJdkProxy() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-aop/docs/part-01-proxy-fundamentals/031-02-jdk-vs-cglib.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_proxyLimitation() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-aop/docs/part-01-proxy-fundamentals/033-04-final-and-proxy-limits.md`
                        """)
                .isFalse();
    }
}
