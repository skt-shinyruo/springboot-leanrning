...
- 现象：同类内部调用的方法不被拦截
- 章节：见 [03. self-invocation](proxy-fundamentals-self-invocation.md)
...
- 章节：见 [04. final-and-proxy-limits](proxy-fundamentals-final-and-proxy-limits.md)
...
深挖入口：见 [00. 深挖指南](guide-deep-dive-guide.md)
...
- 章节：见 [08. pointcut-expression-system](autoproxy-and-pointcuts-pointcut-expression-system.md)
...
- 章节：见 [09. multi-proxy-stacking](proxy-stacking-multi-proxy-stacking.md)
