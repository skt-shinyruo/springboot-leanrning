...
上一章：[第 34 章：05. exposeProxy：用 `AopContext.currentProxy()` 绕过自调用（进阶）](034-05-expose-proxy.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 36 章：07. AOP 的容器主线：AutoProxyCreator 作为 BPP（Advisor / Advice / Pointcut 三层模型）](../part-02-autoproxy-and-pointcuts/036-07-autoproxy-creator-mainline.md)
<!-- GLOBAL-BOOK-NAV:END -->
