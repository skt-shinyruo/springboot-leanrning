...
上一章：[01. AOP 心智模型：代理（Proxy）+ 入口（Call Path）](01-aop-proxy-mental-model.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 自调用（self-invocation）：为什么 `this.inner()` 不会被拦截？](03-self-invocation.md)
<!-- GLOBAL-BOOK-NAV:END -->
