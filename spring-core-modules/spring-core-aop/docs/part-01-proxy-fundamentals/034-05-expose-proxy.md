...
上一章：[第 33 章：04. `final` 与代理限制：为什么 final method 拦截不到？](033-04-final-and-proxy-limits.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 35 章：06. Debug / 观察：如何“看见”代理与切点](035-06-debugging.md)
<!-- GLOBAL-BOOK-NAV:END -->
