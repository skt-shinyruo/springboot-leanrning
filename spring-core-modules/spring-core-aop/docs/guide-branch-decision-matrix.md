...
上一章：[04. 断点地图（Spring AOP Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. AOP 心智模型：代理（Proxy）+ 入口（Call Path）](proxy-fundamentals-aop-proxy-mental-model.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 30 章：01：代理心智模型：拿到的到底是不是“那个对象”】【From Proxy to Target】](proxy-fundamentals-aop-proxy-mental-model.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-proxy-fundamentals/01-aop-proxy-mental-model.md](proxy-fundamentals-aop-proxy-mental-model.md)
