...
上一章：[06. Debug / 观察：如何“看见”代理与切点](../part-01-proxy-fundamentals/06-debugging.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. Pointcut 表达式系统：execution/within/this/target/args/@annotation/...（以及常见误判）](02-pointcut-expression-system.md)
<!-- GLOBAL-BOOK-NAV:END -->

## 导读

- 本章主题：**01. AOP 的容器主线：AutoProxyCreator 作为 BPP（Advisor / Advice / Pointcut 三层模型）**
...
> - [18. refresh 主线：`refresh()` → `doCreateBean()`](../../../spring-core-beans/docs/part-03-container-internals/07-refresh-to-bean-creation-mainline.md)
> - [15. 实例化前短路（pre-instantiation short-circuit）](../../../spring-core-beans/docs/part-03-container-internals/04-pre-instantiation-short-circuit.md)
> - [16. early reference 与循环依赖：`getEarlyBeanReference`](../../../spring-core-beans/docs/part-03-container-internals/05-early-reference-and-circular.md)
> - [31. 代理替换阶段：BPP 如何把 Bean 换成 Proxy（exposed object）](../../../spring-core-beans/docs/part-04-wiring-and-boundaries/14-proxying-phase-bpp-wraps-bean.md)
...
3. **pointcut 是否对目标类/方法适用？**（见 [08. pointcut-expression-system](02-pointcut-expression-system.md)：pointcut 系统）
...
多代理叠加与顺序的完整解释见：[09 - 多代理叠加与顺序](../part-03-proxy-stacking/01-multi-proxy-stacking.md)。
...
上一章：[06-debugging](../part-01-proxy-fundamentals/06-debugging.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[08-pointcut-expression-system](02-pointcut-expression-system.md)
