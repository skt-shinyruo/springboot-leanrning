...
上一章：[01. AOP 的容器主线：AutoProxyCreator 作为 BPP（Advisor / Advice / Pointcut 三层模型）](01-autoproxy-creator-mainline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 并发 / 性能：同一 proxy 并发调用边界（ThreadLocal 不串线）](../part-02-perf-concurrency/01-proxy-concurrency-perf.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- 代理与链条断点导航：见 [00. 深挖指南](../part-00-guide/02-deep-dive-guide.md)、[06. debugging](../part-01-proxy-fundamentals/06-debugging.md)
...
上一章：[07-autoproxy-creator-mainline](01-autoproxy-creator-mainline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[11-proxy-concurrency-perf](../part-02-perf-concurrency/01-proxy-concurrency-perf.md)
