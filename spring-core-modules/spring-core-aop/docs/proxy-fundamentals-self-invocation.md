...
上一章：[02. JDK vs CGLIB：代理类型与“可注入类型”差异](proxy-fundamentals-jdk-vs-cglib.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04. `final` 与代理限制：为什么 final method 拦截不到？](proxy-fundamentals-final-and-proxy-limits.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[02-jdk-vs-cglib](proxy-fundamentals-jdk-vs-cglib.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[04-final-and-proxy-limits](proxy-fundamentals-final-and-proxy-limits.md)
