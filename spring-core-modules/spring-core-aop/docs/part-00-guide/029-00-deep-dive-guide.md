...
上一章：[第 28 章：主线时间线：Spring Core AOP](028-03-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 30 章：01. AOP 心智模型：代理（Proxy）+ 入口（Call Path）](../part-01-proxy-fundamentals/030-01-aop-proxy-mental-model.md)
<!-- GLOBAL-BOOK-NAV:END -->
