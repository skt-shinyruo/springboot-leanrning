...
上一章：[01. 并发 / 性能：同一 proxy 并发调用边界（ThreadLocal 不串线）](../part-02-perf-concurrency/01-proxy-concurrency-perf.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 真实项目叠加 Debug Playbook：AOP/Tx/Cache/Security 如何叠、如何断点验证](02-real-world-stacking-playbook.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
AutoProxyCreator 主线详见：[07 - AutoProxyCreator 主线](../part-02-autoproxy-and-pointcuts/01-autoproxy-creator-mainline.md)。
...
- 配套 playbook：见 [10. real-world-stacking-playbook](02-real-world-stacking-playbook.md)
...
> 继续读 [10. real-world-stacking-playbook](02-real-world-stacking-playbook.md) + 跑 `SpringCoreAopRealWorldStackingLabTest`。
...
上一章：[11-proxy-concurrency-perf](../part-02-perf-concurrency/01-proxy-concurrency-perf.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[10-real-world-stacking-playbook](02-real-world-stacking-playbook.md)
