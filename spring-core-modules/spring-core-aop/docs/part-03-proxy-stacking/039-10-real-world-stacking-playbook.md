...
上一章：[第 38 章：09. 多切面/多代理叠加与顺序：AOP/Tx/Cache/Security 代理链如何叠、如何看](038-09-multi-proxy-stacking.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 40 章：90. 常见坑清单（建议反复对照）](../appendix/040-90-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
