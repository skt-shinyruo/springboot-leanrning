...
上一章：[05. 关键分支矩阵（SpEL）](guide-branch-decision-matrix.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 90 - Common Pitfalls（spring-core-spel）](appendix-common-pitfalls.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 212 章：90 - Common Pitfalls（spring-core-spel）](appendix-common-pitfalls.md)
