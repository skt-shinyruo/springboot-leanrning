...
上一章：[03. SpEL 调用链（parse → AST → evaluate）](guide-spel-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[05. 关键分支矩阵（SpEL）](guide-branch-decision-matrix.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 210 章：04：关键分支矩阵](guide-branch-decision-matrix.md)
...
上一章：[part-00-guide/01-spel-call-chain.md](guide-spel-call-chain.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-00-guide/04-branch-decision-matrix.md](guide-branch-decision-matrix.md)
