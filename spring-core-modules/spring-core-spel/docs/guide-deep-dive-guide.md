...
上一章：[01. 主线时间线：spring-core-spel](guide-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. SpEL 调用链（parse → AST → evaluate）](guide-spel-call-chain.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 210 章：01：SpEL 调用链](guide-spel-call-chain.md)
...
上一章：[part-00-guide/03-mainline-timeline.md](guide-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-00-guide/01-spel-call-chain.md](guide-spel-call-chain.md)
