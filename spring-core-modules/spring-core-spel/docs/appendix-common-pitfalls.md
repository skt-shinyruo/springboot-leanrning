...
上一章：[01. SpEL 入门（root/variables/property access）](spel-basics.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 99 - Self Check（spring-core-spel）](appendix-self-check.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 213 章：99 - Self Check（spring-core-spel）](appendix-self-check.md)
...
上一章：[part-01-spel-basics/01-spel-basics.md](spel-basics.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[appendix/99-self-check.md](appendix-self-check.md)
