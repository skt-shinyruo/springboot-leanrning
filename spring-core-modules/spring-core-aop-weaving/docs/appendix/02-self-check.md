# 02. 自测题：是否真正理解了 weaving？
<!-- CHAPTER-CARD:START -->
!!! summary "章节学习卡片（五问闭环）"

    - 知识点：自测题：是否真正理解了 weaving？
...
上一章：[01. 常见坑清单（LTW/CTW）](01-common-pitfalls.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[第 51 章：事务主线（Tx）](../README.md)
<!-- GLOBAL-BOOK-NAV:END -->
