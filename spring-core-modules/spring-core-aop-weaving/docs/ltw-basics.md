...
改了 pointcut/切面代码，但 advice 依然不触发，于是怀疑表达式

LTW 的前提没满足（缺 agent / 缺 aop.xml / include 范围没覆盖），pointcut 再对也没用
...
先按“三前提”分流确认 LTW 环境，再讨论 join point/pointcut

## 小结与下一章

下一章：[`03-ctw-basics`](ctw-basics.md)
