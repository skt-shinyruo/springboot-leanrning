...
上一章：[02. 深挖指南：把 weaving 的“结论 → 实验 → 排障路径”跑通](guide-deep-dive-guide.md) ｜ 目录：[模块目录](../README.md) ｜ 下一章：[01. LTW：Load-Time Weaving（-javaagent）](ltw-basics.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[00-deep-dive-guide](guide-deep-dive-guide.md) ｜ 目录：[模块目录](../README.md) ｜ 下一章：[02-ltw-basics](ltw-basics.md)
