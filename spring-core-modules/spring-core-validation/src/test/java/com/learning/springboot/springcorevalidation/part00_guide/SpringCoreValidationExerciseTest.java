    ...
    void exercise_addNewConstraint() {
        ...
        assertThat(violations)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-validation/docs/validation-core-constraint-mental-model.md`
                        - `spring-core-modules/spring-core-validation/docs/validation-core-programmatic-validator.md`
    ...
    void exercise_validationGroups() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-validation/docs/validation-core-groups.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_customConstraint() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-validation/docs/validation-core-custom-constraint.md`
                        """)
                .isFalse();
    }
    ...
    void exercise_methodValidationNeedsProxy() {
        assertThat(true)
                .as("""
                        ...
                        建议阅读：
                        - `spring-core-modules/spring-core-validation/docs/validation-core-method-validation-proxy.md`
                        - `spring-core-modules/spring-core-aop/docs/proxy-fundamentals-aop-proxy-mental-model.md`
                        """)
                .isFalse();
    }
