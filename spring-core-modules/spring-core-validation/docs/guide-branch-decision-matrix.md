...
上一章：[04. 断点地图（Validation Debugger Pack）](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 约束（Constraint）心智模型：校验对象与校验结果](validation-core-constraint-mental-model.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
下一章见：[第 158 章：01：约束心智模型：annotation → ConstraintValidator](validation-core-constraint-mental-model.md)
...
上一章：[part-00-guide/02-breakpoint-map.md](guide-breakpoint-map.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[part-01-validation-core/01-constraint-mental-model.md](validation-core-constraint-mental-model.md)
