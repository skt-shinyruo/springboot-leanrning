...
上一章：[02. 深挖指南（Spring Core Validation）](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02. 程序化校验：为什么直接用 `Validator` 仍然很重要？](02-programmatic-validator.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
上一章：[00-deep-dive-guide](../part-00-guide/02-deep-dive-guide.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[02-programmatic-validator](02-programmatic-validator.md)
