...
上一章：[01. 约束（Constraint）心智模型：你在校验什么？校验结果是什么？](01-constraint-mental-model.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 方法参数校验：为什么它必须依赖 Spring 代理？](03-method-validation-proxy.md)
<!-- GLOBAL-BOOK-NAV:END -->
