...
上一章：[01. 约束（Constraint）心智模型：校验对象与校验结果](01-constraint-mental-model.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[03. 方法参数校验：为什么它必须依赖 Spring 代理？](03-method-validation-proxy.md)
<!-- GLOBAL-BOOK-NAV:END -->
...
- Symptom：在对象字段上加了约束，但某条业务路径没有任何校验行为
