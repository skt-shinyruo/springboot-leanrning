...
上一章：[01. 主线时间线：Spring Validation](01-mainline-timeline.md) ｜ 目录：[Docs TOC](../README.md) ｜ 下一章：[01. 约束（Constraint）心智模型：你在校验什么？校验结果是什么？](../part-01-validation-core/01-constraint-mental-model.md)
<!-- GLOBAL-BOOK-NAV:END -->
